...
_CONSISTENCY_SCHEMA = {
    ...
    "properties": {
        ...
        "score": {"type": "integer"},
        "rhythm_consistency_score": {"type": "integer"},
        "volume_consistency_score": {"type": "integer"},
        "clarity_consistency_score": {"type": "integer"},
        "focus_consistency_score": {"type": "integer"},
        "confidence_consistency_score": {"type": "integer"},
        "structure_consistency_score": {"type": "integer"},
