...
async def fluency_session_ws(
    ...
    # Validate parent_id if provided in the start message. We do it before
    # sending "ready" so a bad parent_id closes the WS cleanly without the
    # client thinking the session is live and starting to stream audio.
