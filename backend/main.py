...
# NOTE: Remaining module routers (precision, linguistic_versatility,
# facial_expression, fluency, consistency, live) are temporarily disabled.
# They are being rewritten one by one against the new uniform
